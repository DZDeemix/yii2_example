...
/**
 * ActionTypeSearch represents the model behind the search form about `modules\actions\common\models\ActionType`.
 */
class ActionProductSearch extends ActionProduct implements SearchModelInterface

{
    ...
    protected function prepareFilters($query)
    {
        ...
        $query->andFilterWhere([ 'action_id'=>$this->action_id]);
