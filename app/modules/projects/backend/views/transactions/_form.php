 ...
 * @var modules\projects\backend\models\ProjectTransactionForm $model
...
<?= $form->field($model, 'project_id')->select2(Project::getTitleOptions(), ['prompt' => '(не указан)']) ?>
<?= $form->field($model, 'title')->textInput(['maxlength' => 128]) ?>
<?= $form->field($model, 'type')->radioList(Transaction::getTypeValues()) ?>
<?= $form->field($model, 'amountRubles')->textInput() ?>
<?= $form->field($model, 'comment')->textInput(['maxlength' => 255]) ?><?php $box->endBody() ?>
