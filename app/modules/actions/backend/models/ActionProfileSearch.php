...
/**
 * ActionProfileSearch represents the model behind the search form about `modules\actions\common\models\ActionProfile`.
 */
class ActionProfileSearch extends ActionProfile implements SearchModelInterface
