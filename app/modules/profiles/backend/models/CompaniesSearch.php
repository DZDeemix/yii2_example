...
/**
 * CompaniesSearch represents the model behind the search form about `modules\profiles\common\models\Companies`.
 */
class CompaniesSearch extends Companies implements SearchModelInterface
