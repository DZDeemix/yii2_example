...
/**
 * SaleReportSearch represents the model behind the search form about `modules\sales\common\models\SaleReport`.
 */
class SaleReportSearch extends SaleReport implements SearchModelInterface

{
    ...
    {
        return [
            [['id', 'profile_id', 'action_id'], 'integer'],
