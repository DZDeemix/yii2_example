 ...
 * @var modules\sales\backend\models\SalesActionSearch $model
 * @var yz\admin\widgets\ActiveForm $form
 */
?>

<div class="sales-action-search hidden" id="filter-search">
    ...
    <?= $form->field($model, 'action_from') ?>

    <?= $form->field($model, 'action_to') ?>
